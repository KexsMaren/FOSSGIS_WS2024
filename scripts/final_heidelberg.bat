...
:: --------------------------------------------------------------
:: Make sure to set location and mapset right using GUI. (e.g. Heidelberg: location=loc_heidelberg, mapset=heidelberg, EPSG: 32632)
...
:: First dataset
call r.import input="..\data\heidelberg\LE07_L2SP_195026_20000609_20200918_02_T1_SR_B3.TIF" output=Red_1
call r.import input="..\data\heidelberg\LE07_L2SP_195026_20000609_20200918_02_T1_SR_B4.TIF" output=NIR_1
call r.import input="..\data\heidelberg\LE07_L2SP_195026_20000609_20200918_02_T1_SR_B5.TIF" output=SWIR_1

:: Second dataset
call r.import input="..\data\heidelberg\LC09_L2SP_195026_20230625_20230627_02_T1_SR_B4.TIF" output=Red_2
call r.import input="..\data\heidelberg\LC09_L2SP_195026_20230625_20230627_02_T1_SR_B5.TIF" output=NIR_2
call r.import input="..\data\heidelberg\LC09_L2SP_195026_20230625_20230627_02_T1_SR_B6.TIF" output=SWIR_2
...
:: Load AoI-file
call v.in.ogr input="..\data\heidelberg\heidelberg_aoi.gpkg" output=aoi
...
::call r.out.gdal input=ndbi_1 format=GTiff output="..\results\heidelberg\heidelberg_ndbi_1.tif"
::call r.out.gdal input=ndbi_2 format=GTiff output="..\results\heidelberg\heidelberg_ndbi_2.tif"

::call r.out.gdal input=ndvi_1 format=GTiff output="..\results\heidelberg\heidelberg_ndvi_1.tif"
::call r.out.gdal input=ndvi_2 format=GTiff output="..\results\heidelberg\heidelberg_ndvi_2.tif"

::call r.out.gdal input=ndbi_bi_1 format=GTiff output="..\results\heidelberg\ndbi_bi_1.tif"
::call r.out.gdal input=ndbi_bi_2 format=GTiff output="..\results\heidelberg\ndbi_bi_2.tif"

::call r.out.gdal input=ndvi_bi_1 format=GTiff output="..\results\heidelberg\ndvi_bi_1.tif"
::call r.out.gdal input=ndvi_bi_2 format=GTiff output="..\results\heidelberg\ndvi_bi_2.tif"

::call r.out.gdal input=diff_bi_1 format=GTiff output="..\results\heidelberg\diff_bi_1.tif"
::call r.out.gdal input=diff_bi_2 format=GTiff output="..\results\heidelberg\diff_bi_2.tif"
...
call d.mon start=png output="..\results\heidelberg\diff_bi_1_map.png"
...
:: Start png graphic monitor
call d.mon start=png output="..\results\heidelberg\diff_bi_2_map.png"
